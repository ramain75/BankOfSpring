 ...
 * <code>credit(User loggedInUser, Account toAccount, long amount)</code>
 * 
 * 
 * @author ram
 *
 */
public class BankServiceCreditAccountThreeParamsTest extends
	...
	public void testCreditAccountWithNoUser() {
		try {
			bankService.credit(null, account10000001, 1000L);
	...
	public void testCreditAccountWithZeroAmount() {
		try {
			bankService.credit(janice, account10000001, 0L);
		} catch (RuntimeException re) {
			assertEquals("RuntimeException message not as expected",
	...
	public void testCreditAccountWithNoAccount() {
		try {
			bankService.credit(janice, null, 1000L);
		} catch (RuntimeException re) {
			assertEquals("RuntimeException message not as expected",
